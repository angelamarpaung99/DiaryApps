...
public class ListNotesActivity extends AppCompatActivity {
    ...
    public void initRecyclerView() {
        ...
        mLayoutManager = new LinearLayoutManager(ListNotesActivity.this);
    ...
    public void initDummy() {
        ...
        mLists.add(new ListNotesModel("1", "https://t-ec.bstatic.com/images/hotel/max1024x768/136/136201154.jpg" , "Paradise Lost", Tools.getCurrentDateISO8601().toString()));
        mLists.add(new ListNotesModel("2", "https://t-ec.bstatic.com/images/hotel/max1024x768/136/136201154.jpg" , "Paradise Lost", Tools.getCurrentDateISO8601().toString()));
        mLists.add(new ListNotesModel("3", "https://t-ec.bstatic.com/images/hotel/max1024x768/136/136201154.jpg" , "Paradise Lost", Tools.getCurrentDateISO8601().toString()));
        mLists.add(new ListNotesModel("4", "https://t-ec.bstatic.com/images/hotel/max1024x768/136/136201154.jpg" , "Paradise Lost", Tools.getCurrentDateISO8601().toString()));
